...
my_emptyList.append('Python')
print(my_emptyList)
my_emptyList.append('Guido van Rossum')
print(my_emptyList)

del my_emptyList[0]
print(my_emptyList)
my_emptyList.append('is the inventor of')
print(my_emptyList)

my_emptyList.append(my_emptyList.pop(0))
print(my_emptyList)
...
for i in range(5):
    ...
    user_umber = int(input("Enter number of the words: "))
